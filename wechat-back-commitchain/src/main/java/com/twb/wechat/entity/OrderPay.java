...
public class OrderPay  {
	...
	public static String STATE_PREPAY = "1";//待支付
	public static String STATE_PAY = "2";//支付成功
	public static String STATE_PAY_COMMITCHAIN = "3";//支付成功上链
	public static String STATE_PAY_COMMITCHAIN_SUCCESS = "4";//上链成功
	public static String STATE_PAY_COMMITCHAIN_FAIL = "5";//上链失败
